        ...
        {error && (
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 mb-6">
            ...
            <button
              ...
              className="text-sm text-red-600 dark:text-red-400 underline mt-2 cursor-pointer"
            >
              Tekrar dene
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((project) => (
            ...
            >
              {/* Görsel */}
              <div
                className="h-48 bg-gradient-to-br from-blue-100 to-indigo-100
              ...
              <div className="p-4">
                <div className="flex items-start justify-between mb-2">
                  ...
                  {project.featured && (
                    <span className="bg-yellow-100 dark:bg-yellow-900/40 text-yellow-800 dark:text-yellow-200 text-xs px-2 py-0.5 rounded-full">
                      Öne Çıkan
                    </span>
                  )}
                </div>
