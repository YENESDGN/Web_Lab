      ...
      <div className="relative">
        <input
          ...
          className="w-full border border-gray-300 dark:border-gray-600 rounded-lg
            px-4 py-2 pl-10 bg-white dark:bg-gray-800 text-gray-900 dark:text-white
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        ...
        <div className="flex gap-2 items-center">
          ...
          <button
            ...
            className="border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-1.5 text-sm
              hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-white transition-colors cursor-pointer"
