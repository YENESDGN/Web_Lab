    ...
    return (
      <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 text-center">
        ...
        <button
          ...
          className="mt-4 text-sm text-green-600 dark:text-green-400 underline cursor-pointer"
        >
          Yeni mesaj gönder
        </button>
      </div>
    ...
    <form onSubmit={handleSubmit} className="space-y-4 max-w-lg" noValidate>
      ...
      <div>
        ...
        <textarea
          ...
          className={`w-full border rounded-lg px-3 py-2 resize-y bg-white dark:bg-gray-800 text-gray-900 dark:text-white
            focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors
      ...
      <button
        ...
        className="w-full bg-blue-600 text-white py-2 rounded-lg font-medium
          hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
      >
